const Faq = () => {
  return (
    <div>
      <h1>FAQ</h1>
      <div>
        <h2>1. Que faire en cas de peste noire ?</h2>
      ...
      <div>
        <h2>2. Est-ce que la saignée peut guérir le mal de tête ?</h2>
        <p>- Absolument, mais seulement si vous avez trop de sang !</p>
        <p>- Oui, mais préparez-vous à vous sentir un peu léger.</p>
      </div>
      <div>
        <h2>
          3. Les potions magiques sont-elles garanties sans effets secondaires ?
        </h2>
        <p>
          - Non, les effets secondaires incluent des hallucinations et une envie
          de danser.
        </p>
      ...
      <div>
        <h2>4. Puis-je combiner une saignée avec une purge ?</h2>
        <p>- Oui, mais assurez-vous d’avoir un lit bien confortable.</p>
        <p>- Non, cela pourrait vous transformer en fantôme !</p>
        <p>
          - Seulement si vous êtes suivi par un médecin médiéval expérimenté.
        </p>
      </div>
      <div>
        <h2>5. Quel est le meilleur remède pour les piqûres de dragon ?</h2>
      ...
      <div>
        <h2>6. Comment puis-je savoir si je suis possédé par un démon ?</h2>
        <p>- Consultez un exorciste et faites-vous purifier.</p>
        <p>- Vérifiez si vous avez une aversion pour l’ail.</p>
        <p>
          - Si vous commencez à parler des langues anciennes, c’est un signe.
        </p>
      </div>
      <div>
        <h2>7. Combien de sang est-il sûr de donner lors d’une saignée ?</h2>
      ...
      <div>
        <h2>8. Les potions d’amour fonctionnent-elles vraiment ?</h2>
      ...
      <div>
        <h2>9. Que faire si mon pigeon voyageur se perd ?</h2>
      ...
      <div>
        <h2>10. Puis-je utiliser une potion de guérison sur mon cheval ?</h2>
        <p>
          - Non, les potions pour humains peuvent être toxiques pour les
          chevaux.
        </p>
